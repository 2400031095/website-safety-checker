...
function Home() {
  ...
  const handleCheck = async () => {
    ...
    try {
      ...
      // Toast notifications based on verdict (case-insensitive)
      ...
      } else if (verdict === "safe" || verdict?.startsWith("safe")) {
              ...
              <span
                style={{
                  color:
                    ...
                    result.verdict?.startsWith("Safe")
                      ? "green"
                      : result.verdict?.toLowerCase() === "unsafe"
                      ? "red"
                      : "orange",
                  fontWeight: "bold",
                }}
